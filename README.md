...
Every level collapses, and what you folded is remembered per user.
...
Same rows, same filter, same actions - plus one tick-box per group to select everything under it.
